        ...
        const fetchData = async () => {
            ...
            try {
                ...
                const formattedData = Object.entries(outletData).map(([date, sales]) => ({
                    date,
                    sales: Math.round(Number(sales) * 100) / 100, // Round to 2 decimals and ensure it's a number
    ...
    return (
        <div className="glass-card p-6 rounded-xl">
            <div className="flex justify-between items-center mb-6">
                ...
                >
                    <option className="bg-gray-800 text-white" value="andheri">Andheri</option>
                    <option className="bg-gray-800 text-white" value="dadar">Dadar</option>
                    <option className="bg-gray-800 text-white" value="borivali">Borivali</option>
                    <option className="bg-gray-800 text-white" value="bhayander">Bhayander</option>
                </select>
            </div>
