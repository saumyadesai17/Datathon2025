...
#         # Process Order_List column (convert string representation of list to actual list)
#         self.df['Order_List'] = self.df['Order_List'].apply(eval)
...
#         # Get similar users' purchase histories
#         similar_users_matrix = self.user_item_matrix.iloc[similar_user_indices]
        
#         # Get user's current items
#         user_items = set(self.df_exploded[
#             self.df_exploded['User_ID'] == user_id
#         ]['Order_List'].tolist())
...
#         recommendations = weighted_rec.sort_values(
#             'score', 
#             ascending=False
#         )
...
#             ~recommendations.index.isin(user_items)
#         ]
